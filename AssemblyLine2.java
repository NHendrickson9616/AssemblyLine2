...
public class AssemblyLine2{
    ...
    private static void setStats(){
        ...
        prodMap.put("Plutonium Cell", new AssemblyLineProduct("Plutonium Cell", 5, "Radioactive Crafter MK1", new Pair[]{
        ...
        prodMap.put("Plutonium Circuit", new AssemblyLineProduct("Plutonium Circuit", 5, "Radioactive Crafter MK1", new Pair[]{
        ...
        prodMap.put("Uranium Cell", new AssemblyLineProduct("Uranium Cell", 5, "Radioactive Crafter MK1", new Pair[]{
            new Pair(prodMap.get("Uranium"), 2.), new Pair(prodMap.get("Solar Cell"), 2.), 
            new Pair(prodMap.get("Diamond Liquid"), 2.), new Pair(prodMap.get("Gold Cable"), 2.),
            new Pair(prodMap.get("Copper Cable"), 2.), new Pair(prodMap.get("Refined Plutonium"), 4.2)}));
        prodMap.put("Uranium Circuit", new AssemblyLineProduct("Uranium Circuit", 5, "Radioactive Crafter MK1", new Pair[]{
    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<String, AssemblyLineProduct> entry : prodMap.entrySet()) {
            ...
            System.out.println(printPairList(entry.getValue().getRawMats()));
        }
    }
